...
(Considere para cada aerolínea 1 puesto de atención)
...
vuelo y aerolinea para hacer el check-in.
...
La idea es que haya un guardia por cada puesto.
...
los puestos de embarque 1 a 7, en la terminal B los puestos del 8 a 15 y en la terminal C del 16 a
20.
...
cada free-shop tiene una capacidad para “lugar” personas, es decir que si ya esta cubierta lacapacidad no podrán ingresar mas personas hasta que alguna abandone el free shop y deje el lugar.
...
atencion y quedan pocos pasajeros. Se podria considerar un tiempo maximo de espera.
